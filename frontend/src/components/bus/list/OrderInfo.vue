    ...
    <div class="d-flex justify-content-between align-items-center pb-3">
      <div class="pointer d-flex gap-5 align-items-center" @click="toggleTemplateSeatMap">
        ...
        <div class="d-flex gap-4">
          <div class="d-flex flex-column">
            <StartEndOrder
              :departure="props.order.departure.time"
              :arrival="props.order.arrival.time"
            />
      ...
      <div class="d-flex align-items-center is-gap-8">
        ...
        <div class="d-flex gap-3 align-items-center">
          <div
            class="pointer price-ticket d-flex flex-column align-items-end"
            @click="toggleTemplateSeatMap"
          >
          ...
          <div>
            <button
              class="pointer button button-choose"
              type="button"
              v-if="!showSeatMap"
              @click="toggleTemplateSeatMap"
            >
            ...
            <button
              class="pointer button button-close"
              type="button"
              v-if="showSeatMap"
              @click="toggleTemplateSeatMap"
            >
