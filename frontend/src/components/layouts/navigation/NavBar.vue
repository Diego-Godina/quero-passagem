...
<template>
  <BoxContent>
    <nav class="d-flex flex-row align-items-center justify-content-between pt-2 bg-white">
      ...
      <div class="d-flex">
        <div class="me-5">
          <AButton title="Central de ajuda" link="/atendimento" icon="icon_atendimento-online_ajuda.svg"/>
        </div>
        <div>
          <blue-button title="Entrar" link="/login"/>
        </div>
      </div>
    </nav>
  </BoxContent>
